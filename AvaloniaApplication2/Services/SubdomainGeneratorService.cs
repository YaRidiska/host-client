...
{
    public class SubdomainGeneratorService
    {
    ...
    "zoo",
    "phoenix", "shadow", "storm", "frost", "flame", "thunder",
    "cosmic", "stellar", "lunar", "solar", "astro", "nova", "nebula", "quasar",
    "cyber", "tech", "pixel", "digital", "crypto", "quantum", "nano", "mega",
    "ultra", "hyper", "super", "meta", "omega", "alpha", "beta", "gamma",
    "delta", "sigma", "prime", "flux", "wave", "pulse", "beam",
    "mesh", "stream", "flow", "surge",
    "spark", "blitz", "swift", "rapid", "dash", "bolt", "flash", "zoom",
    "apex", "peak", "summit", "zenith", "vertex", "nexus",
    "prism", "helix", "spiral", "vortex",
    "byte", "bit", "chip",
    "forge", "atlas", "titan", "hydra", "kraken", "griffin",
    "wyrm", "drake", "sage", "mage", "rogue", "knight", "paladin", "wizard",
    "ninja", "samurai", "viking", "pirate", "ranger", "hunter", "warrior", "mystic",
    "abyss", "dusk", "twilight",
    "mech", "bot", "droid", "neural",
    "fusion", "plasma", "laser", "ion", "photon", "neutron", "electron", "proton",
    "binary", "hex", "hash", "block", "chain",
    "shell", "kernel", "gem", "pearl", "emerald", "sapphire", "topaz"
        };

        private readonly Random _random;

        public SubdomainGeneratorService()
        {
            _random = new Random();
        }
        ...
        {
            var number1 = _random.Next(10);
            var number2 = _random.Next(10);

            var word1 = Words[_random.Next(Words.Length)];
            var word2 = Words[_random.Next(Words.Length)];

            word1 = word1.ToLower();
            word2 = word2.ToLower();

            return $"{word1}{number1}-{word2}{number2}";
        }
    }
}